"""Regression checks for the meridian-store-column-runner casebook."""
...
from casebook.harness import assert_expected, meridian_store_column_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_store_column_runner_summary(), assert_expected())
