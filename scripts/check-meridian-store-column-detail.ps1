...
$repo = "meridian-store-column-runner"
$language = "Swift"
$category = "Databases"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/meridian-store-column-walkthrough.md")) {
